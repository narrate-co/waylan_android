...
fun isLikelyUnlockDesiredScenario(
    ...
    val rotationEventPeriodsQualifies
            = maxPeriodBetweenRotations <= RotationConsts.MAX_PERIOD_BETWEEN_ROTATIONS_FOR_VALID_PATTERN_NANOS
    val acclamationPeriodQualifies =
            now - observedSince <= RotationConsts.FRESH_INTERACTION_ROTATION_ACCLAMATION_PERIOD_NANOS
