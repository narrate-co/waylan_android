 ...
 * For example, the [Word] <i>quiescent</i>'s [Sound] might have the [wavs] 'quiesce_1.wavs'.
 *
 ...
 *
 * Furthermore, you can strip the [Sound.wavs] or [Sound.wprs]'s trailing file type and replace it
