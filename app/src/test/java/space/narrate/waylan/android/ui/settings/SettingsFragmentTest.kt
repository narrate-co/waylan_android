...
class SettingsFragmentTest: AutoCloseKoinTest() {
    ...
    private val mainViewModel = mock(MainViewModel::class.java)
    ...
    private val shouldLaunchAuth: MutableLiveData<Event<AuthRoute>> = MutableLiveData()
    ...
    fun setUp() {
        ...
        whenever(settingsViewModel.shouldLaunchAuth).thenReturn(shouldLaunchAuth)
