 ...
 *
 * To toggle whether this Service is run, use [WordsetDatabase.SHOULD_SEED_DATABASE].
 */
class WordsetDatabaseSeedService: Service(), CoroutineScope {
    ...
    private fun seed() {
        //Get db instance
        val db = WordsetDatabase.getInstance(applicationContext)
